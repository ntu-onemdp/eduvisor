...
class ChatController:
    ...
    # def process_query(self, query, user_id, loaded_faiss_vs, llm):
    ...
    #     if "explain more" in query.lower().strip():
    #         last_response_response = self.chat_model.get_last_response(user_id)
    ...
    #                 response, token_used, main_topic = (
    #                     self.chat_service.invoke_response(
    #                         llm,
    #                         persona,
    #                         task,
    #                         conditions,
    ...
    #             save_response = self.chat_model.save_chat(
    #                 user_id, course_id, cur_chat_id_counter, query, response, main_topic
    #             )
    ...
    #         # Update token usage
    #         update_tokens_response = self.user_model.update_tokens_used(
    #             user_id, token_used
    #         )
