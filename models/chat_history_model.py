...
class ChatHistoryModel:
    ...
    def get_chat_history(self, user_id, course_id):
        ...
        try:
            chats = list(self.collection.find({"user_id": user_id, "course_id": course_id}, {"_id": 0}))
            if chats:
    ...
    def delete_chat_by_user(self, user_id):
        ...
        try:
            ...
            if result.deleted_count > 0:
                return response_handler(200, "Chat(s) deleted", {"deleted_count": result.deleted_count})
            else:
