...
def main():
    ...
    st.markdown(
        '<div  class = "admintitle" >Admin Portal</div>', unsafe_allow_html=True
    )
    st.markdown(
        '<div  class = "admin-header"> Organize course materials and manage student access.</div>',
    ...
    if user_role in ["ADMIN", "OWNER"]:
        ...
        student_portal_view = StudentPortalView(
            controller=admin_controller, user_id=user_id
        )
