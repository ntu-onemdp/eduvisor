...
def main():
    ...
    st.markdown('<div class = "coursestitle" >Course-specific chatbots</div>', unsafe_allow_html=True)
    st.markdown('<div class = "courses-header" >Chat with our chatbots to get course-related answers and guidance!</div>', unsafe_allow_html=True)
    ...
    with st.spinner('Loading'):
        ...
        if is_admin:  # dn student access if admin
            ...
            course_view.display_course_grid(courses_list,allowed_course_list, is_admin=False)
            course_view.display_question_guide()
