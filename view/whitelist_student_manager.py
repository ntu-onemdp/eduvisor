...
class WhitelistStudentView:
    ...
    def list_whitelisted_students(self, course_id):
        ...
        with st.container(height=150):
            if students_response["code"] == 200:
                ...
                st.markdown(f"<b>Students in course '{course_id}':</b>", unsafe_allow_html=True)
                ...
                for student_email in whitelisted_students:
                    ...
                    with col2:
                        if st.button("Remove", key=student_email):
                            delete_response = self.controller.remove_student(course_id, student_email)
    ...
    def process_uploaded_file(self, course_id, uploaded_file):
        ...
        if st.button("Upload whitelist files", type='primary') and uploaded_file and course_id:
            ...
            try:
                ...
                if course_response["code"] == 404:
                    status_placeholder.error(f"Course '{course_id}' not found. Please add the course first in the course page before proceeding.")
                    return
                ...
                if emails:
                    ...
                    status_placeholder.error("No emails extracted from the uploaded file. Please check the format.")
